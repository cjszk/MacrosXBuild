  ...
  render() {
    return (
      <View style={styles.main}>
        <Text style={styles.header}>Version 1.20</Text>
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            ...
            flexible dieters. If you like MacrosX please do leave a 5-star
            review in the app store and tell your friends!
          </Text>
        </View>
        <Text style={styles.text}>Changes with this version:</Text>
        <Text style={styles.text}>
          1. MacrosX now uses FatSecret's database!
        </Text>
        <Text style={styles.text}>
          2. Users can now scan barcodes for quicker and more convenient
          tracking.
        </Text>
        <Text style={styles.text}>Plans for near future:</Text>
        <Text style={styles.text}>1. Complete redesign underway.</Text>
